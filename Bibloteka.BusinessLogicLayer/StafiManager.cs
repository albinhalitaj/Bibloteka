...
namespace Bibloteka.BusinessLogicLayer
{
    public class StafiManager
    {
        ...
        public void Update(string id, Stafi stafi,Perdoruesi perdoruesi,int roliID) => StafiDal.UpdateStafin( id,stafi,perdoruesi, roliID);
        ...
        public DataTable GetShtetiByID(string id) => StafiDal.GetShtetiById(id);
