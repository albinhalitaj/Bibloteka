...
namespace Bibloteka.Forms
{
    public partial class frm_ShtoKlient : Form
    {
        ...
        private void comboShteti_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "Kosovë":
                    comboQyteti.Items.AddRange(GetCities("Kosovë"));
                    comboQyteti.SelectedIndex = 16;
                    break;
                case "Shqipëri":
                    comboQyteti.Items.AddRange(GetCities("Shqipëri"));
                    comboQyteti.SelectedIndex = 0;
                    break;
                case "Mali i Zi":
                    comboQyteti.Items.AddRange(GetCities("Mali i Zi"));
                    comboQyteti.SelectedIndex = 0;
                    break;
                case "Maqedoni":
                    comboQyteti.Items.AddRange(GetCities("Maqedoni"));
